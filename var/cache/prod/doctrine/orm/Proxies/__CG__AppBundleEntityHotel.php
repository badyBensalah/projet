 ...
 */
class Hotel extends \AppBundle\Entity\Hotel implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Hotel' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Hotel' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Hotel' . "\0" . 'classement', '' . "\0" . 'AppBundle\\Entity\\Hotel' . "\0" . 'adresse'];
        }
