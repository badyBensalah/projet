 ...
 */
class Guide extends \AppBundle\Entity\Guide implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Guide' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Guide' . "\0" . 'etat', '' . "\0" . 'AppBundle\\Entity\\Guide' . "\0" . 'datePublication', '' . "\0" . 'AppBundle\\Entity\\Guide' . "\0" . 'contenu', '' . "\0" . 'AppBundle\\Entity\\Guide' . "\0" . 'publisher', '' . "\0" . 'AppBundle\\Entity\\Guide' . "\0" . 'pays'];
        }
