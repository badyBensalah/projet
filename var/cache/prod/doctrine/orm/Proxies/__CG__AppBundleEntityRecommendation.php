 ...
 */
class Recommendation extends \AppBundle\Entity\Recommendation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Recommendation' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Recommendation' . "\0" . 'commentaire', '' . "\0" . 'AppBundle\\Entity\\Recommendation' . "\0" . 'note', '' . "\0" . 'AppBundle\\Entity\\Recommendation' . "\0" . 'userName', '' . "\0" . 'AppBundle\\Entity\\Recommendation' . "\0" . 'compagnie', '' . "\0" . 'AppBundle\\Entity\\Recommendation' . "\0" . 'service', '' . "\0" . 'AppBundle\\Entity\\Recommendation' . "\0" . 'pays'];
        }
