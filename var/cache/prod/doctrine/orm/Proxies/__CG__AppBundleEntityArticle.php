...
class Article extends \AppBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'datePublication', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'description', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'lien', '' . "\0" . 'AppBundle\\Entity\\Article' . "\0" . 'publisher'];
        }
