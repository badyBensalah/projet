 ...
 */
class Voyage extends \AppBundle\Entity\Voyage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Voyage' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Voyage' . "\0" . 'typeDeTransport', '' . "\0" . 'AppBundle\\Entity\\Voyage' . "\0" . 'dateDebut', '' . "\0" . 'AppBundle\\Entity\\Voyage' . "\0" . 'dateFin'];
        }
    ...
    public function setTypeDeTransport($typeDeTransport)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypeDeTransport', [$typeDeTransport]);

        return parent::setTypeDeTransport($typeDeTransport);
    }
    ...
    public function getTypeDeTransport()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypeDeTransport', []);

        return parent::getTypeDeTransport();
    }
